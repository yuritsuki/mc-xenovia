    ...
    export default {
        ...
        mounted() {
            ...
            $(this.$el).daterangepicker({
                ...
                "startDate": component.year ? moment().startOf('year') : moment().startOf('month'),
                "endDate": moment(),
                "maxDate": component.noMax ? moment().add(5,'years').endOf('year') : moment(),
